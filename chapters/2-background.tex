...
\end{figure}
\unsure{there was an equation here but it is better in the figure?}
...
Unsupervised learning discovers structure from unlabeled data without explicit targets. Common tasks include clustering, association rule learning, and dimensionality reduction. \improvement{does this need to be longer?}\unsure{should I write just about supervised learning?}
...
\info{I want to have this section because it is relevant for my feature extraction. But I see it overlaps with general VideoMAE}
