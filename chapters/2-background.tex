...
% \textcite
% A number of large-scale video datasets have been developed to advance action recognition research. \textcite{survey_of_survey} provides comprehensive overviews of available sports-related action datasets (see their Tables 4 & 5), while Seweryn et al.~\cite{seweryn_survey_2023} focus specifically on football-centric collections. Below, we summarize the main datasets examined in this thesis, ordered by their relevance and scale.
...
\unsure{Move to back of chapter, or reference this part in the back of the chapter?}
